...
Repository scaffold and data-audit pipeline are implemented. The original files need to be placed in `archive/original_project/` before their actual merge logic can be extracted and validated.
